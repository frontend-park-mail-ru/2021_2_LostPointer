...
class PlayerComponent extends Component {
    ...
    private currentHandler: EventListenerOrEventListenerObject;
    ...
    update() {
        ...
        (document.getElementById('player-artwork') as HTMLImageElement).src = `${this.data.cover ?? '/src/static/img/artworks/no_artwork'}_128px.webp`;
    }
}
