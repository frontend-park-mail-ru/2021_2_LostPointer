...
// TODO! стили сообщения в окошке изменения
...
// TODO! выровнять по левому краю аватару плейлиста и список треков
// TODO адаптировать под мобилку
// TODO! поменять заголовок в окошке изменения - Edit Details
// TODO! выровнять компоненты в окошке изменения
// TODO функционал удаления аватары
// TODO! усилить тень при открытии окошка изменения - 0.8
